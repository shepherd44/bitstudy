...
3_menu.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CMy3_menuApp 응용 프로그램
    클래스를 선언합니다.

3_menu.cpp
    응용 프로그램 클래스 CMy3_menuApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
3_menuDoc.h, 3_menuDoc.cpp - 문서
    이 파일에는 CMy3_menuDoc 클래스가 들어 있습니다.  이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CMy3_menuDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

3_menuView.h, 3_menuView.cpp - 문서 뷰
    이 파일에는 CMy3_menuView 클래스가 들어 있습니다.
    CMy3_menuView 개체는 CMy3_menuDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 3_menu.pch와
