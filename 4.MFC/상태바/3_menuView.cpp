...
void CMy3_menuView::OnDraw(CDC*  pDC)
{
	...
	CWindowDC dc ( pFrame->GetStatusBar()); 

	int w; 
	UINT id = 0;
	UINT s = 0; 
	pFrame->GetStatusBar()->GetPaneInfo(0, id, s, w);
	CRect rect(0,0,100, w );
//	pFrame->GetStatusBar()->GetWindowRect( &rect);
...
void CMy3_menuView::OnMouseMove(UINT nFlags, CPoint point)
{
	...
	// 좌표 추가 !! 
	pFrame->GetStatusBar()->SetPaneText( 1 , str);
